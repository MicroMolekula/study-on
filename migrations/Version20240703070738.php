 ...
 */
final class Version20240703070738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT NOT NULL, chars_code VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1000) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_169E6FB938F35D6F ON course (chars_code)');
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, ordering INT NOT NULL, PRIMARY KEY(id))');
